...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.jianzhishipinName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
						...
						<view class="text" :style='{"color":"#f06f4f","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.jianzhishipinValue}}</view>
					</view>
					...
					<view class="detail-list-item"
						...
						<view class="lable"
							...
							点击次数：</view>
						<view class="text" :style='{"color":"#f06f4f","textAlign":"center","fontSize":"24rpx"}'>
							{{detail.jianzhishipinClicknum}}</view>
					</view>
...
<!-- 视频 -->
			<view style="text-align: center;padding: 20upx;box-sizing: border-box;background: #FFFFFF;"
				...
				<view class="uni-padding-wrap uni-common-mt">
					<view>
						<video id="myVideo" style="preload:auto" muted :src="detail.jianzhishipinVideo" controls></video>
					</view>
				</view>
			</view>
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.jianzhishipinContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('jianzhishipin', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.jianzhishipinPhoto ? this.detail.jianzhishipinPhoto.split(",") : [];
			},
